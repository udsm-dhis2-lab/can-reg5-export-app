...
const eventsQuery = {
    results: {
        ...
        params: ({
            ...
            program: 'rx6V962E4XM',
            fields: [
                'attributes[attribute,value],enrollments[trackedEntityInstance,enrollment,events[storedBy,event,programStage,dataValues[dataElement,value]]]',
            ],
...
export const Tumour = () => {
    ...
    const exportTSVFile = trackedEntityInstances => {
        ...
        const fileContents = new Blob([tumourTableData], {
